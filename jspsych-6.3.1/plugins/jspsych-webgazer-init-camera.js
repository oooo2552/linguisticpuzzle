...
jsPsych.plugins["webgazer-init-camera"] = (function() {
    ...
    parameters: {
      instructions: {
        ...
        default: `
            ...
            <p>実験中、あなたの頭をこの位置に維持しているのは重要なので、パソコンをしやすい姿勢を調整してください。</p>
            ...
            <p>あなたの顔を上の正方形の中にして、緑を見えたら、「つづき」をクリックしてください。。</p>
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function showTrial() {
      ...
      console.log(jsPsych.extensions['webgazer']);  //object

      let video = document.querySelector("#webgazerVideoContainer");
      console.log(video);
